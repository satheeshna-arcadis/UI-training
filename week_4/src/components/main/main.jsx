...
import { CalendarCheck2, Settings, HelpCircle, User, Search, ArrowRight, X, PlusCircle, MessageCircle } from 'lucide-react';
        ...
        <div className="flex flex-col flex-grow overflow-hidden" role="main">
            <nav className="flex items-center justify-between bg-gray-100 text-gray-800 px-4 py-5 flex-shrink-0" role="navigation" aria-label="Main navigation">
                <div className="flex items-center gap-4 w-full">
                    ...
                    <div className="flex md:hidden flex-grow justify-center"> <button aria-label="Search" type="button"><Search className="w-5 h-5" aria-hidden="true" /></button></div>
                    <div className="flex items-center gap-4 ms-auto">
                        <button aria-label="Calendar" type="button"><CalendarCheck2 className="w-5 h-5" aria-hidden="true" /></button>
                        <button aria-label="Settings" type="button"><Settings className="w-5 h-5" aria-hidden="true" /></button>
                        <button aria-label="Help" type="button"><HelpCircle className="w-5 h-5" aria-hidden="true" /></button>
                        <button aria-label="User profile" type="button"><User className="w-5 h-5" aria-hidden="true" /></button>
                    </div>
                </div>
            </nav>
            <div className="flex-1 overflow-y-auto">
                <div className="bg-gradient-to-r from-rose-50 to-indigo-50 px-4 py-3 flex items-center flex-wrap relative" role="alert">
                    ...
                    <button aria-label="Close notification" type="button"><X className="w-5 h-5" aria-hidden="true" /></button>
                </div>
                ...
                <main className=" p-6 space-y-8" role="main" aria-label="Main content area">
                    <div className="flex justify-between items-center" role="banner" aria-label="Apps header">
                        ...
                        <button className="bg-red-600 text-white flex items-center px-3 py-2 rounded-md text-sm" type="button" aria-label='Add new apps'>
                            <PlusCircle className="w-4 h-4 me-1" aria-hidden="true" /> Add apps
                        </button>
                    </div>
                    ...
                    <ul className="grid grid-cols-2 sm:grid-cols-3 gap-4" aria-label="Previously added apps">
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open App Studio">
                                <img src="https://img.icons8.com/color/48/source-code.png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>App Studio</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open Assignments">
                                <img src="https://img.icons8.com/color/48/lock--v1.png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>Assignments</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open Excel">
                                <img src="https://img.icons8.com/color/48/ms-excel.png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>Excel</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open Power BI">
                                <img src="https://img.icons8.com/?size=100&id=qYfwpsRXEcpc&format=png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>Power BI</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open PowerPoint">
                                <img src="https://img.icons8.com/color/48/ms-powerpoint.png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>PowerPoint</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-md border border-gray-200" type="button" aria-label="Open Task Module Sample">
                                <img src="https://img.icons8.com/?size=100&id=jzaaE6lUq9fx&format=png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>Task Module Sample →</span>
                            </button>
                        </li>
                        <li>
                            <button className="flex items-center gap-2 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition" type="button" aria-label="Open Word">
                                <img src="https://img.icons8.com/color/48/ms-word.png" className="w-10 h-10" alt="" aria-hidden="true" />
                                <span>Word</span>
                            </button>
                        </li>
                    </ul>
                    ...
                    <div className="flex  gap-3 px-4 py-4 justify-end">
                        <button className="bg-gray-800 text-white px-4 py-2 rounded-lg flex items-center gap-2" type="button" aria-label="Provide feedback">
                            <MessageCircle className="w-4 h-4" aria-hidden="true" /> Feedback
                        </button>
                        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2" type="button" aria-label="Get help">
                            <HelpCircle className="w-4 h-4" aria-hidden="true" /> Need help?
                        </button>
                    </div>
                </main>
            </div>
